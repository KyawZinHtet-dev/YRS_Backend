...
import { SearchIcon, Settings2, TrainFront, XIcon } from 'lucide-react';
        ...
        <Card>
            <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex flex-col gap-2">
                    ...
                    <CardDescription>Manage stations here.</CardDescription>
                </div>
                <div>
                    <Dialog>
                        <TooltipProvider>
                        ...
                        <DialogContent className="md:max-w-[600px] lg:max-w-[800px] xl:max-w-[1000px]">
                            <DialogHeader>
                                ...
                                <DialogDescription>Create a new station here. Click create when you're done.</DialogDescription>
                            </DialogHeader>
