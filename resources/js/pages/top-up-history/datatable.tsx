        ...
        <Card>
            <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex flex-col gap-2">
                    <CardTitle>Top Up History Table</CardTitle>
                    <CardDescription>Manage your top up history here.</CardDescription>
                </div>
            </CardHeader>
            <CardContent>
            ...
            <CardFooter className="block">
                <DataTablePagination
                    ...
                    last_page={last_page}
                    table={table}
                    routePath="top-up-history.index"
                />
            </CardFooter>
        </Card>
    );
