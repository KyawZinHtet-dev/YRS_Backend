...
import { SearchIcon, Settings2, TicketPlus, XIcon } from 'lucide-react';
        ...
        <Card>
            <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex flex-col gap-2">
                    <CardTitle>Ticket Pricing Table</CardTitle>
                    <CardDescription>Manage ticket pricings here.</CardDescription>
                </div>
                <div>
                    <Dialog>
                        <TooltipProvider>
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    <p>Create Ticket Pricing</p>
                                </TooltipContent>
                            </Tooltip>
                        </TooltipProvider>
                        <DialogContent className="md:max-w-[600px] lg:max-w-[800px]">
                            <DialogHeader>
                                <DialogTitle>Create Ticket Pricing</DialogTitle>
                                <DialogDescription>Create a new ticket pricing here. Click create when you're done.</DialogDescription>
                            </DialogHeader>
                            <TicketPricingForm mode="create" />
                            <DialogFooter>
                                <DialogClose asChild>
            ...
            <CardFooter className="block">
                <DataTablePagination
                    ...
                    last_page={last_page}
                    table={table}
                    routePath="ticket-pricings.index"
                />
            </CardFooter>
        </Card>
    );
