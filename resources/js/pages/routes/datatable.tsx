...
import { SearchIcon, Settings2, Waypoints, XIcon } from 'lucide-react';
        ...
        <Card>
            <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex flex-col gap-2">
                    ...
                    <CardDescription>Manage routes here.</CardDescription>
                </div>
                <div>
                    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                        ...
                        <DialogContent className="md:max-w-[600px] lg:max-w-[800px] xl:max-w-[1000px]">
                            <DialogHeader>
                                ...
                                <DialogDescription>Create a new route here. Click create when you're done.</DialogDescription>
                            </DialogHeader>
                            <RouteForm mode="create" setDialogOpen={setDialogOpen} />
                            <DialogFooter>
                                <DialogClose asChild>
